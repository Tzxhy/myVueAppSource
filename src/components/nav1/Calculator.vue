<template>
	<div class="body">
		<div class="htmleaf-container">
			<div class="htmleaf-content" style="height: 140vh;margin-top: 100px;">
				<div class="calc-main">
	...
	<!-- <script src="./Cal/js/CalcSS3.js"></script> -->
</template>

<!-- <script src="./Cal/js/CalcSS3.js" defer></script> -->
<script>
	export default {
		created(){
			require.ensure([], function(require){ // 加载过的不会再次加载. 把需要加载的代码改成cmd格式, 再执行
				var a = require('./Cal/js/CalcSS3.js');
				a(window);
			});
		},
		destroyed(){
...
<style scoped lang="less">
	@import './Cal/css/normalize.css';
	@import './Cal/css/default.css';
	@import './Cal/css/CalcSS3.css';
	@import './Cal/css/index.css';
</style>